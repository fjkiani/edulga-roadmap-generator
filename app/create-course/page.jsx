  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-center mt-10'>
        <h2 className='text-4xl text-primary font-medium'>Create Roadmap</h2>
      ...
      <div className='flex justify-between mt-10'>
       ...
       {activeIndex==2&& <Button disabled={checkStatus()}  onClick={() => GenerateCourseLayout()}>Generate Roadmap Layout</Button>}
